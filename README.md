...
- 후기
   ...
   -첫 프로젝트이였던만큼 부족한 지식과 경험으로 인해 애로사항이 있었지만,진행하면서 미숙했던 부분을 다시 복습을 하고 이론을 실제로 적용해보면서 최종 결과물을 잘 마무리 할 수 있었습니다.스프링부트 , Mybatis 및 AJax 등 을 적용하면서 개발 속도가 2배 이상 빨라졌습니다. 
   기본적인 웹페이지 구동에 대한 지식뿐만 아니라 학습하는 습관과 문제해결 능력을 키웠고 협업의 기본 과정 등 많은걸 깨닳고 발전이 됬던 좋은 경험의 프로젝트였습니다.
