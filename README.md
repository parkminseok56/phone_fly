...
- 프레임워크 
  ...
  - MyBatis 
  - <img src="https://oopy.lazyrockets.com/api/v2/notion/image?src=https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F41857ea2-4aa9-4820-983b-9f9fdd329118%2FUntitled.png&blockId=0cf4d07a-6ed8-4680-acba-295b14863c4b" width="150">
## 분할구조도
...
## DB 설계
<p align="center">
 <img src="https://github.com/parkminseok56/phone_fly/assets/133790403/b16848d7-cb94-42e5-9a61-62b2c4e64908"width="1000">
</p>
...
- 역할분담
  ...
  - 박민석: 사용자/관리자 페이지 작성 및 디버깅
  
  - 백현성: 사용자/관리자 페이지 작성 및 디버깅,프론트 앤드 디자인 및 기능, 모바일 페이지 작성

  - 이경민: 사용자/관리자 페이지 작성 및 디버깅

  - 전진웅: DB 데이터 관리 및 사용자 페이지 작성  및 디버깅
 
- 후기
  
   - 첫 프로젝트이였던만큼 부족한 지식과 경험으로 인해 애로사항이 있었지만,진행하면서 미숙했던 부분을 다시 복습을 하고 이론을 실제로 적용해보면서 최종 결과물을 잘 마무리 할 수 있었습니다. 기술적으로는 스프링부트 , Mybatis 및 AJax 등 을 적용하면서 개발 속도가 2배 이상 빨라지는 경험을 하였고, 기본적인 웹페이지 구동에 대한 지식뿐만 아니라 학습하는 습관과 문제해결 능력을 키웠고 협업의 기본 과정 등 많은걸 깨닳고 발전이 됬던 좋은 경험의 프로젝트였습니다.
