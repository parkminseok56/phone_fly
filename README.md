...
- 첫 프로젝트였던 만큼 제 지식과 경험이 부족하여 도중에 애로사항이 있었지만, 프로젝트를 진행하면서 이론을 실전에 적용하며 지속적으로 배우며,
  ...
  또한, 데이터베이스 설계, 다이어그램 작성, 기능 정의서 작성 등과 같은 협업의 기본적 인 단계들을 배우며 다양한 것들을 습득했습니다.
  프로젝트 개발이 완료된 이후에는 팀원들과 함께 코드 리뷰를 통해 사용한 소스 코드 등을 공유하며 서로 발전할 수 있는 기회가 되었던 좋은 경험의 프로젝트였습니다.
