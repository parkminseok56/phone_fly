...
<h1 id="guide-title">개인정보 처리방침</h1>
...
<div id="main-card-box">
    ...
    <p>주식회사 PhoneFly는 (이하 &quot;회사&quot;는) 고객님의 개인정보를 중요시하며, &quot;정보통신망 이용촉진 및 정보보호&quot;에 관한 법률을 준수하고 있습니다.<br />
...
- 회원가입시 : 이름 , 휴대전화번호 , 이메일 , SNS 정보, 성별, CI<br />
- 서비스 신청시 : 생년월일, 주소,통신사 정보<br />
o 서비스 이용 과정이나 사업 처리 과정에서 서비스이용기록, 접속로그, 쿠키, 접속 IP, 결제 기록, 불량이용 기록이 생성되어 수집될 수 있습니다.<br />
<br />
나. 수집방법<br />
- 홈페이지, 게시판, 이메일, 이벤트 응모, 배송요청, 전화, 팩스, 생성 정보 수집 툴을 통한 수집<br />
<br />
■ 개인정보의 수집 및 이용목적<br />
...
회원이 탈퇴한 경우에도 불량회원의 부정한 이용의 재발을 방지, 분쟁해결 및 수사기관의 요청에 따른 협조를 위하여, 이용계약 해지일로부터 1년간 회원의 정보를 보유할 수 있습니다.<br />
<br />
