...
<div class="wrap join-form-wrap card-normal">
	...
	<form method="post" name="joinForm" action="/join">
		...
		<fieldset>
			...
			<div class="form-floating mb-3">
				<input type="text" name="address2" id="sample6_detailAddress" class="form-control" size="30" placeholder=" 상세주소를 입력하세요" maxlength="100" /><label for="sample6_detailAddress">상세주소</label>
			</div>
			<div class="form-floating mb-3">
				<input type="text" name="address3" id="sample6_extraAddress" class="form-control" size="30" placeholder=" 기타주소(세부사항)을 입력하세요" maxlength="100" /><label for="sample6_extraAddress">기타주소(세부사항)</label>
			</div>
			<div class="form-floating mb-3">
